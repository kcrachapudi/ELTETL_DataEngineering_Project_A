...
sources = [
    ...
    (test_json_weather,          "weather_json",       ["time", "latitude", "longitude"], "json", "sample_data/json/weather_response.json"),    (test_json_okta_users,      "okta_users",          ["id"],                    "json",        "sample_data/json/okta_users.json"),
